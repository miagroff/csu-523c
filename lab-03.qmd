...
pip_irrigation <- pip_fun(hex_crop, irrigation, "id")
pip_hydroelectric <- pip_fun(hex_crop, hydroelectric, "id")
pip_navigation <- pip_fun(hex_crop, navigation, "id")
pip_recreation <- pip_fun(hex_crop, recreation, "id")
```
...
```{r}
plot_pip(pip_irrigation)
plot_pip(pip_hydroelectric)
plot_pip(pip_navigation)
plot_pip(pip_recreation)
```
